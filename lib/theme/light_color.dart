...
class LightColor {
  ...
  static const Color titleTextColor = Color.fromRGBO(6, 65, 61, 1.0);
  ...
  static const Color appgreen = Color(0xff06413d);
  static const Color appgreenlight = Color(0xff0c645e);
  static const Color appgreenExtraLight = Color(0xff198c84);
